...
exports.deleteRunById = deleteRunById;
...
exports.DEFAULT_CATEGORIES = [
    ...
    { id: "socio", label: "Socio", kind: "neutro", builtin: true, color: (0, categoryColors_1.colorForCategoryId)("socio") },
    { id: "renta", label: "Renta", kind: "gasto", builtin: true, color: (0, categoryColors_1.colorForCategoryId)("renta") },
    { id: "servicios", label: "Servicios", kind: "gasto", builtin: true, color: (0, categoryColors_1.colorForCategoryId)("servicios") },
    { id: "apps", label: "Apps / software", kind: "gasto", builtin: true, color: (0, categoryColors_1.colorForCategoryId)("apps") },
    ...
    { id: "transferencia_persona", label: "Transferencia sin nombre", kind: "neutro", builtin: true, color: (0, categoryColors_1.colorForCategoryId)("transferencia_persona") },
