...
export type KommoWebhookLeadBucket =
  | Array<Partial<KommoLead> & { id?: number | string }>
  | (Partial<KommoLead> & { id?: number | string })
  | Record<string, Partial<KommoLead> & { id?: number | string }>
  | undefined;
