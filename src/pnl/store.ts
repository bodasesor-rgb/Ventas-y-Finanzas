...
export const DEFAULT_CATEGORIES: CategoryDef[] = [
  ...
  { id: "socio", label: "Socio", kind: "neutro", builtin: true, color: colorForCategoryId("socio") },
  ...
  { id: "transferencia_persona", label: "Transferencia sin nombre", kind: "neutro", builtin: true, color: colorForCategoryId("transferencia_persona") },
